...
[create a proposal](https://github.com/laminas/laminas-dependency-plugin/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/laminas/laminas-dependency-plugin.git
  $ cd laminas-dependency-plugin
  ```
...
2. Fork the repository (https://github.com/laminas/laminas-dependency-plugin)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/laminas-dependency-plugin.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/laminas-dependency-plugin.git
